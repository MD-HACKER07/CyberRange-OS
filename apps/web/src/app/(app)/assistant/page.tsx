  ...
  return (
    <div className="p-8">
      <PageHeader
        ...
        subtitle="Ask about routines, schedules, or the platform — by voice or text. Answered by our CyberSec model."
        actions={
        ...
        <div className="space-y-4">
          <Card>
            ...
            <ul className="text-sm text-vault-white/60 space-y-2 list-disc pl-5">
              ...
              <li>Answers are generated by the department&apos;s own CyberSec model.</li>
